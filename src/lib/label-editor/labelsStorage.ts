...
export function addLabelToPlaces(places: GeoJSON.FeatureCollection<GeoJSON.Point,GeoJSON.GeoJsonProperties> | undefined, value: string, lngLat: LngLat, mapZoomLevel: number, borderOwnerId: string | number | undefined) {
...
export function editLabelInPlaces(labelId: string, places: GeoJSON.FeatureCollection<GeoJSON.Point,GeoJSON.GeoJsonProperties> | undefined, value: string, lngLat: LngLat, mapZoomLevel: number) {
  if (!places) return
  if (!value) {
